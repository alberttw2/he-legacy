...
?>
    ...
    public function mail_getHistoryInfo(){
        ...
        $this->session->newQuery();
        $sql = "SELECT infoDate, info1 FROM mails_history WHERE mid = :mid LIMIT 1";
        $stmt = $this->pdo->prepare($sql);
        $stmt->execute(array(':mid' => $this->mid));
